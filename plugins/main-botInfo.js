  ...
  let who = m.quoted
    ...
    : m.mentionedJid && m.mentionedJid[0]
      ...
      : m.fromMe
        ? conn.user.jid
        : m.sender
  if (!(who in global.db.data.users)) throw `The user is not found !!....`
  let pp = await conn.profilePictureUrl(who, 'image').catch(_ => './Horizon-Media/HORIZON-V.jpeg')
...
𝓟𝓸𝔀𝓮𝓻𝓮𝓭 𝓫𝔂 𝓗𝓞𝓡𝓘𝓩𝓞𝓝-𝓜𝓓 @ 𝑅𝐸𝐷𝐹𝑂𝑋 𝐼𝑁𝐶
`
