      ...
      if (chat.welcome) {
        ...
        for (let user of participants) {
          ...
          try {
            ...
            pp = 'https://i.imgur.com/5lbN4va.jpeg' // Assign default image URL
            ppgp = 'https://i.imgur.com/5lbN4va.jpeg' // Assign default image URL
          } finally {
            ...
            let welcomeimg = 'https://i.imgur.com/5lbN4va.jpeg'
            ...
            try {
              this.sendMessage(id, {
                ...
                contextInfo: {
                  ...
                  externalAdReply: {
                    title: 'HORIZON-MD',
                    body: 'you\'re welcomed...',
                    thumbnailUrl: welcomeimg,
      ...
      if (chat.welcome) {
        ...
        for (let user of participants) {
          ...
          try {
            ...
            let leaveIMG = 'https://i.imgur.com/5lbN4va.jpeg'
...
watchFile(file, async () => {
  unwatchFile(file)
  console.log(chalk.redBright('Update ind_msg_con.js'))
